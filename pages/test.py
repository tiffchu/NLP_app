...
if df is not None:
    ...
    view_categories = ["View each mood individually", "View all moods collectively (select 3 moods)", "Measure how the mood changes over time for a single relationship"]
    ...
    if st.button("Perform Emotion Detection"):
        ...
        if view_format == "View all moods collectively (select 3 moods)":
            ...
            mentee_sample_data = df[df['Mentor'] == 'Mentee' or 'Mentor']
